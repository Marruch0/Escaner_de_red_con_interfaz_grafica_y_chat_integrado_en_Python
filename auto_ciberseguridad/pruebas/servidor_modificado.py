...
- /ban <usuario> <minutos> [razón] - Bloquea a un usuario por un tiempo
- /unban <usuario> - Desbloquea a un usuario
- /banlist - Muestra la lista de usuarios bloqueados
- /userlist - Muestra la lista de usuarios registrados
- /adduser <usuario> <contraseña> [admin] - Crea un nuevo usuario
- /deluser <usuario> - Elimina permanentemente un usuario
- /logs [número] - Muestra los logs del servidor
- /help - Muestra esta ayuda
"""
        socket.sendall(ayuda.encode())
